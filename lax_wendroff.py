"""Provides the function lax_wendroff to use inside swe_solver.py."""


def lax_wendroff(dx, dy, dt, g, u, v, h, u_tendency, v_tendency):
    """
    Calculate one timestep of the Lax-Wendroff scheme applied to the SWEs.

    Returns: tuple u_new, v_new, h_new
